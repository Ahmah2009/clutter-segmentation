...
especially in the case of \icedtea's; its $x$-$y$-histogram has roughly the
form of a hash ('\#'). 
...
\fatFreeMilk can be made out on the histogram (\refFigure{figure:tod-model-xyhist} c).  Just like \icedtea, \fatFreeMilk is a cuboid. Hence, their
