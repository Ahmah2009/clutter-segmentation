...
pixel $\hat{q}$ on the digital image plane. For the $n$ correspondences for
this object, this means
...
\begin{figure}[h]
    \begin{center}
        \includegraphics[width=0.7\textwidth]{media/ransac-max-projection-error-deficiency}
