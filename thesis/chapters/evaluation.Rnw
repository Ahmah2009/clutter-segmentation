...
\begin{equation}
    \oTvi{j}: \vec{p} \mapsto\ \fTv \left(\vec{p}\right)
\end{equation}
...
\begin{equation}
    \oTvi{i}: \vec{p} \mapsto\ \fTv \left(\vec{p} - \begin{pmatrix} 0.15 \\ 0 \\ 0 \end{pmatrix} \right)
\end{equation}

\begin{equation}
    \oTvi{k}: \vec{p} \mapsto\ \fTv \left(\vec{p} + \begin{pmatrix} 0.13 \\ 0 \\ 0 \end{pmatrix} \right)
\end{equation}
...
\begin{equation}
    \hat{q}_i := U\left(\ \oTvh\left(p_i\right)\right)
\end{equation}
...
\begin{equation}
    \forall{i \in \left[n\right]}:\quad c_i\ \text{ is an inlier w.r.t. }\ \oTvh\quad \Leftrightarrow \quad \normtwo{\ q_i - \hat{q}\ } \le r
\end{equation}
