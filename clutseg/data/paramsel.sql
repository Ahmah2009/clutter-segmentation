...
insert into experiment (paramset_id, response_id, name, train_set, test_set, time, vcs_commit, skip) values (1, null, "orb-bf-binary", "ias_kinect_train_v2", "ias_kinect_test_all", null, null, 0); 
