...
recognition system as presented in Chapter~\ref{chapter:implementation}. It
provides a review of required mathematical tools and the basics of multi-view
3-d object recognition. It covers the description of images using local
...
features, discussed in Section~\ref{subsection:SIFT}, it is possible
