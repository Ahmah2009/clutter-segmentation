...
insert into response (
    ...
    avg_detect_matches,
    avg_detect_inliers,
    avg_detect_best_matches,
    avg_detect_best_inliers,
    avg_locate_matches,
    avg_locate_inliers,
    avg_locate_best_matches,
    avg_locate_best_inliers
    ) values
    (0.78, 0.34, 0.08, 0.12, 0.02, 0.56, 0.15, 0.53, 0.03, 0.63, 0.05, 913.0, 652.3, 9.2, 211.9, 13.3, 802.1, 29.8, 802.1, 39.8);
...
insert into experiment (paramset_id, response_id, train_set, test_set, sample_size, time, vcs_commit) values (1, 1, "train", "test", 5, "2010-01-02 23:22:19", "ccb521d7307ef27a65ab82f297be80390b5599bb");
