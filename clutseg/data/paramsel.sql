...
insert into experiment (paramset_id, response_id, train_set, test_set, sample_size, time, vcs_commit) values (1, null, "ias_kinect_train_v2", "ias_kinect_test_grounded", 20, null, null); 
