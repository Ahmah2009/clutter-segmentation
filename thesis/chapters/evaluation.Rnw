...
\begin{equation}
    \oTvi{j}: \vec{p} \mapsto\ \fTv \parenth{\vec{p}}
\end{equation}
...
\begin{equation}
    \oTvi{i}: \vec{p} \mapsto\ \fTv \parenth{ \vec{p} - \begin{pmatrix} 0.15 \\ 0 \\ 0 \end{pmatrix} }
\end{equation}

\begin{equation}
    \oTvi{k}: \vec{p} \mapsto\ \fTv \parenth{ \vec{p} + \begin{pmatrix} 0.13 \\ 0 \\ 0 \end{pmatrix} }
\end{equation}
...
\begin{equation}
    \hat{q}_i := U\parenth{ \ \oTvh \parenth{ p_i}\ }
\end{equation}
