...
namespace clutseg {
    ...
    /**
     * \brief Bundles all information about a single test scene evaluated
     * during the run of an experiment.
     *
     * It has knowledge about the input and output, plus basic statistics local
     * to the single test scene.  Given such test reports, global statistics
     * can easily be generated by aggregation. It's equally easy to process a
     * test report locally, e.g.  for storing results to the filesystem. */
    struct TestReport {
