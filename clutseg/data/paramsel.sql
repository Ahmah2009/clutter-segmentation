...
insert into pms_fe (detector_type, extractor_type, descriptor_type, threshold, scale_factor, min_features, max_features, n_features, octaves) values ("ORB-OpenCV", "ORB-OpenCV", "ORB-OpenCV", null, 1.2, null, null, 5000, 3);
insert into pms_fe (detector_type, extractor_type, descriptor_type, threshold, scale_factor, min_features, max_features, n_features, octaves) values ("ORB-OpenCV", "ORB-OpenCV", "ORB-OpenCV", null, 1.2, null, null, 5000, 3);
...
insert into pms_fe (detector_type, extractor_type, descriptor_type, threshold, scale_factor, min_features, max_features, n_features, octaves) values ("FAST", "multi-scale", "rBRIEF", 40, 1.2, null, null, 5000, 3);
insert into paramset (train_pms_fe_id, recog_pms_fe_id, detect_pms_match_id, detect_pms_guess_id, locate_pms_match_id, locate_pms_guess_id, recog_pms_clutseg_id) values (2, 4, 3, 3, 4, 4, 2);
