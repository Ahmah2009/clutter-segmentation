...
\begin{table}[h!]
  \begin{center}
    ...
    \end{tabular}
    \caption[Hard- and software configuration for parameter optimization]{Hard- and software configuration for parameter optimization.}
...
\begin{table}[h!]
  \begin{center}
    ...
    \caption[Hard- and software configuration for computation speed benchmark]
        {Hard- and software configuration for computation speed benchmark.}
