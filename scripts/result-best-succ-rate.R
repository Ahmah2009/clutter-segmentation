...
system(gettextf("result-montage locate_choice.collage %d", experiment_id[1]))
system(gettextf("convert %s/locate_choice.collage.%05d.jpg -resize %%20 %s/best_succ_rate.locate_choice.collage.jpg", artifact_dir, experiment_id[1], artifact_dir))
