...
error threshold on the image plane is chosen too large.  We proposed an
enhancement to RANSAC that involves a projection error threshold that depends
on the distance of the aligned model point to the image plane.
