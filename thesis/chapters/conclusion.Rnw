...
a speed-up of %TODO
times over brute-force matching in the validation scenes, and both the success rate
and the average guess score were not impacted by trading exactness for speed.
