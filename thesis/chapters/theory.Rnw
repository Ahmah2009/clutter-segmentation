...
is also called model coordinate system in the literature \cite{Pope2000}. Both
...
to find the extrinsic parameters of the camera; given that the correspondencies
