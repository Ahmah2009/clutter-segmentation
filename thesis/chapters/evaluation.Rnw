...
\begin{table}
    \begin{center}
        \begin{tabular}{lr}
            ...
            \jacobsCoffee   & 8912 \\
        \end{tabular}
        \caption[The number of model features of \assamTea, \haltbareMilch, \icedtea, and \jacobsCoffee]
...
many textured objects]{Many textured objects in the scene render recognition
...
\begin{figure}
    \begin{center}
        ...
        \caption[The PR2 graps \assamTea]{The PR2 grasps \assamTea.}
        \label{figure:grasp}
    \end{center}
\end{figure}
