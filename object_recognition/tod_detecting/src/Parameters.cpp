...
const string ClusterParameters::YAML_NODE_NAME = "ClusterParameters";
...
{
  type = (string)fn["matcher_type"];
  ratioThreshold = (float)fn["ratio_threshold"];
  knn = (int)fn["knn"];
  doRatioTest = (int)fn["do_ratio_test"];
}

const string MatcherParameters::YAML_NODE_NAME = "MatcherParameters";
